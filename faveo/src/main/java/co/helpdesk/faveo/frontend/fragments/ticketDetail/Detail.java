...
public class Detail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressDialog.setMessage("Encontrando Detalles");
        progressDialog.show();
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (subject.trim().length() == 0) {
                    setErrorState(editTextSubject, textViewErrorSubject, "Llena todos los campos");
                    allCorrect = false;
                ...
                if (allCorrect) {
                    if (InternetReceiver.isConnected()) {
                        progressDialog.setMessage("Actualizando prioridad");
                        progressDialog.show();
                        try {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jsonObject1.getString("first_name").equals("") || jsonObject1.getString("first_name") == null) {
                    editTextFirstName.setText("No disponible");
                } else
                ...
                if (jsonObject1.getString("last_name").equals("") || jsonObject1.getString("last_name") == null) {
                    editTextLastName.setText("No disponible");
                } else
                ...
                if (jsonObject1.getString("email").equals("") || jsonObject1.getString("email") == null) {
                    editTextEmail.setText("No disponible");
                } else
                ...
                if (jsonObject1.getString("duedate").equals("") || jsonObject1.getString("duedate") == null) {
                    editTextDueDate.setText("No disponible");
                } else {
                ...
                if (jsonObject1.getString("created_at").equals("") || jsonObject1.getString("created_at") == null) {
                    editTextCreatedDate.setText("No disponible");
                } else {
                ...
                if (jsonObject1.getString("updated_at").equals("") || jsonObject1.getString("updated_at") == null) {
                    editTextLastResponseDate.setText("No disponible");
                } else {
...
//                    editTextLastMessage.setText(jsonObject1.getString("last_message"));
    ...
    public class SaveTicket extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            if (subject.equals("No disponible"))
                subject = "";
        ...
        protected void onPostExecute(String result) {
            progressDialog.dismiss();
            Log.d("resultado de la edicion", result + "");
            if (result == null) {
                Toast.makeText(getActivity(), "Se ha provocado un error", Toast.LENGTH_LONG).show();
                return;
            }
            if (result.contains("ticket_id"))
                Toast.makeText(getActivity(), "Actualizado exitosamente", Toast.LENGTH_LONG).show();
            else
                Toast.makeText(getActivity(), "Fallo al actualizar prioridad", Toast.LENGTH_LONG).show();
        }
    }
