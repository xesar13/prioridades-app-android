...
public class LoginActivity extends AppCompatActivity implements InternetReceiver.InternetReceiverListener {
        ...
        buttonVerifyURL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (companyURL.trim().length() == 0 || !Patterns.WEB_URL.matcher(companyURL).matches()) {
                    Toast.makeText(v.getContext(), "Favor de ingresar una url valida", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public class VerifyURL extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                ...
                Toast.makeText(context, "URL Invalida", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            if (result.contains("success")) {
                ...
                Toast.makeText(context, "Error verificando URL", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public class SignIn extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            Log.d("Login Ingresado", result);
            progressDialogSignIn.dismiss();
            if (result == null) {
                Toast.makeText(LoginActivity.this, "Ha provocado un error", Toast.LENGTH_SHORT).show();
                return;
            } else {
                try {
    ...
    private void setUsernameErrorStates() {
        textViewFieldError.setText("Ingresa un Usuario por favor");
    ...
    private void setUpViews() {
        ...
        progressDialogVerifyURL.setMessage("Verificando URL");
        progressDialogVerifyURL.setCancelable(false);

        progressDialogSignIn = new ProgressDialog(this);
        progressDialogSignIn.setMessage("Ingresar");
    ...
    private void showSnackIfNoInternet(boolean isConnected) {
        if (!isConnected) {
            final Snackbar snackbar = Snackbar
                    .make(findViewById(android.R.id.content), "Lo Sentimos! No se ha conectado a internet", Snackbar.LENGTH_INDEFINITE);
