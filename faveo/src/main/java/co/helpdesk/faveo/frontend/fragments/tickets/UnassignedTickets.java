...
//            }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                Toast.makeText(getActivity(), "Algo Fallo!", Toast.LENGTH_LONG).show();
                return;
            }
            if (result.equals("all done")) {

                Toast.makeText(context, "Realizado!", Toast.LENGTH_SHORT).show();
                //return;
            }
       ...
       FetchNextPage(Context context) {
        ...
        protected void onPostExecute(String result) {
            if (result == null)
                return;
            if (result.equals("all done")) {
                Toast.makeText(context, "Todas las Prioridades cargadas", Toast.LENGTH_SHORT).show();
                return;
            }
