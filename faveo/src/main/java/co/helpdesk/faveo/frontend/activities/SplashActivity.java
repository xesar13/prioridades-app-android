...
public class SplashActivity extends AppCompatActivity implements InternetReceiver.InternetReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else Toast.makeText(this, "Oops! No hay internet", Toast.LENGTH_LONG).show();
    }
    ...
    public class FetchDependency extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                ...
                Toast.makeText(SplashActivity.this, "Ha provocado un error", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            loading.setText("Se termino de Cargar!");
    ...
    public class FetchData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            progressDialog.setVisibility(View.GONE);
            loading.setText("Se ha terminado de cargar!");
            if (result == null) {
                Toast.makeText(SplashActivity.this, "Ha provocado un error", Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private void showSnackIfNoInternet(boolean isConnected) {
        if (!isConnected) {
            final Snackbar snackbar = Snackbar
                    .make(findViewById(android.R.id.content), "Lo Sentimos! No esta conectado a internet", Snackbar.LENGTH_INDEFINITE);
