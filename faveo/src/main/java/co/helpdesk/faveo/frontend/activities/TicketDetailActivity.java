...
import co.helpdesk.faveo.frontend.fragments.ticketDetail.Conversacion;
...
public class TicketDetailActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(ticketNumber == null ? "Desconocido" : ticketNumber);
        ...
        buttonCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (note.trim().length() == 0) {
                    Toast.makeText(TicketDetailActivity.this, "Mensaje Vacio", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (userID != null && userID.length() != 0) {
                    ...
                    progressDialog.setMessage("Creando Nota");
                    progressDialog.show();

                } else
                    Toast.makeText(TicketDetailActivity.this, "userID Error", Toast.LENGTH_LONG).show();
            }
        });
                ...
                if (cc.length() > 0) {
                    ...
                    for (String email : multipleEmails) {
                        if (email.length() > 0 && !Helper.isValidEmail(email)) {
                            Toast.makeText(TicketDetailActivity.this, "Invalido CC", Toast.LENGTH_LONG).show();
                            return;
                        }
                    }
                }
...
//        findViewById(R.id.fab_sheet_item_note).setOnClickListener(this);
    ...
    public class CreateInternalNote extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                Toast.makeText(TicketDetailActivity.this, "Ha provocado un error", Toast.LENGTH_LONG).show();
                return;
            }
            Toast.makeText(TicketDetailActivity.this, "Nota Interna publicada", Toast.LENGTH_LONG).show();
            exitReveal();
        }
    }
    ...
    public class ReplyTicket extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(TicketDetailActivity.this, "Respuesta Publicada", Toast.LENGTH_LONG).show();
            try {
...
//                }
    ...
    private void setupViewPager() {
        ...
        fragmentConversation = new Conversacion();
        fragmentDetail = new Detail();
        adapter.addFragment(fragmentConversation, "CONVERSACION");
        adapter.addFragment(fragmentDetail, "DETALLE");
    ...
    private void showSnackIfNoInternet(boolean isConnected) {
        if (!isConnected) {
            final Snackbar snackbar = Snackbar
                    .make(findViewById(android.R.id.content), "Lo Sentimos! No conectado a internet", Snackbar.LENGTH_INDEFINITE);
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (isConnected) {
            ...
            Snackbar snackbar = Snackbar
                    .make(findViewById(android.R.id.content), "Conectado a Internet", Snackbar.LENGTH_LONG);
