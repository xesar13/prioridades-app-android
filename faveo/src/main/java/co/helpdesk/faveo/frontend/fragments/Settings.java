...
public class Settings extends Fragment implements CompoundButton.OnCheckedChangeListener, CompoundButton.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setActionBarTitle("Ajustes");
        return rootView;
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.switch_crash_reports: {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                        ...
                        .setMessage("Para aplicar estos ajustes, debe reiniciar la app!")
                        .setCancelable(false)
                        ...
                        .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                startActivity(i);
                                Toast.makeText(getContext(), "Reiniciando...", Toast.LENGTH_LONG).show();
                            }
                        });
